...
typedef struct
{
  ...
  __IOM uint8_t  SHP[12U];               /*!< Offset: 0x018 (cnt/W)  System Handlers Priority Registers (4-7, 8-11, 12-15) */
  ...
  __IM  uint32_t PFR[2U];                /*!< Offset: 0x040 (cnt/ )  Processor Feature Register */
  __IM  uint32_t DFR;                    /*!< Offset: 0x048 (cnt/ )  Debug Feature Register */
  __IM  uint32_t ADR;                    /*!< Offset: 0x04C (cnt/ )  Auxiliary Feature Register */
  __IM  uint32_t MMFR[4U];               /*!< Offset: 0x050 (cnt/ )  Memory Model Feature Register */
  __IM  uint32_t ISAR[5U];               /*!< Offset: 0x060 (cnt/ )  Instruction Set Attributes Register */
